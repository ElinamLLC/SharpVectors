...
namespace ZoomPanControlSample
{
    ...
    public partial class ZoomPanOverview : UserControl
    {
        ...
        private ZoomPanPageMode _pageMode;
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (_viewportBox == null || _viewportCanvas == null)
            {
        ...
        private ScrollableZoomPanPage GetScrollablePage()
        {
            return this.DataContext as ScrollableZoomPanPage;
        }

        private InfiniteZoomPanPage GetInfinitePage()
        {
            return this.DataContext as InfiniteZoomPanPage;
        }
