...
Partial Public Class InfiniteZoomPanPage
    Inherits Page
    ...
    Private Sub OnPageLoaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        If _mainWindow IsNot Nothing Then
            ...
            _wndOverview.Title = "Zoom Overview - Infinite"
            _wndOverview.PageMode = ZoomPanPageMode.Infinite
    ...
    Private Sub OnZoomPanMouseDown(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
        ...
        If (Keyboard.Modifiers And ModifierKeys.Shift) <> 0 AndAlso (e.ChangedButton =
            MouseButton.Left OrElse e.ChangedButton = MouseButton.Right) Then
    ...
    Private Shared Function FitZoom(ByVal actualWidth As Double, ByVal actualHeight As Double,
                                    ByVal contentWidth As Double?, ByVal contentHeight As Double?) As Double
            ...
            Function(t)
                Try
                    ...
                    If drawingStream.Length <> 0 Then
                        ...
                        zoomPanControl.ZoomTo(1.0)
                        zoomPanControl.AnimatedSnapTo(New Point(bounds.X + bounds.Width / 2, bounds.Y + bounds.Height / 2))
                    End If
