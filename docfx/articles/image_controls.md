---
uid: topic_image_controls
title: SVG Image Controls
---

# SVG Image Controls

The image controls provide SVG-based static images for use in WPF applications by extending the [Image](xref:System.Windows.Controls.Image) control class. Currently, the following two controls are provided:

* [SvgBitmap](xref:SharpVectors.Converters.SvgBitmap), a basic SVG image control class.
* [SvgIcon](xref:SharpVectors.Converters.SvgIcon), a specialization of the basic SVG image control class to handle monochrome SVG images.
...
The [SvgBitmap](xref:SharpVectors.Converters.SvgBitmap) control extends the WPF [Image](xref:System.Windows.Controls.Image) control class, and provides the following additional properties:

* **SvgBitmap.UriSource** is used to set the [Uri](xref:System.Uri) of the SVG document to be converted to the image source.
...
![SvgBitmap](../images/svgbitmap.png)

## SvgIcon Control

The [SvgIcon](xref:SharpVectors.Converters.SvgIcon) control is a specialization of the [SvgBitmap](xref:SharpVectors.Converters.SvgBitmap) control for monochrome SVG documents, and provides the following additional properties:

* **SvgIcon.Fill** defines the [Uri](xref:System.Windows.Media.Brush) be used to fill any element that has a fill style.
* **SvgIcon.Stroke** defines the [Uri](xref:System.Windows.Media.Brush) be used to stroke any element that has a stroke style.
