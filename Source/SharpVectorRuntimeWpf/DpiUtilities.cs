...
namespace SharpVectors.Runtime
{
    public static class DpiUtilities
    {
        ...
        private const uint _defaultPixelsPerInch = 96;
        ...
        {
            return new DpiScale((double)dpi1X / dpi2X, (double)dpi1Y / dpi2Y);
        }
        ...
        public static DpiScale GetSystemScale()
        {
            ...
            return CalculateScale(systemDpiX, systemDpiY, DefaultPixelsPerInch, DefaultPixelsPerInch);
        }
        ...
        {
            return GetWindowScale(GetWindowHwnd(visual));
        }
        ...
        public static DpiScale GetVirtualPixelScale(IntPtr hwnd)
        {
            ...
            return CalculateScale(dpiX, dpiY, DefaultPixelsPerInch, DefaultPixelsPerInch);
        }
        ...
        {
            return NativeMethods.GetWindowHwnd(visual);
        }
