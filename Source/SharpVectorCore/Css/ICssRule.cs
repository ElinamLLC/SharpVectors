namespace SharpVectors.Dom.Css
{
    ...
    public interface ICssRule
    {
        ...
        /// </summary>
        /// <exception cref="DomException">SYNTAX_ERR: Raised if the specified CSS string value has a syntax 
        /// error and is unparsable.</exception>
        /// <exception cref="DomException">INVALID_MODIFICATION_ERR: Raised if the specified CSS string value 
        /// represents a different type of rule than the current one.</exception>
        /// <exception cref="DomException">HIERARCHY_REQUEST_ERR: Raised if the rule cannot be inserted at this 
