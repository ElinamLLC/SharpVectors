...
{
    /// <summary>
    /// Interaction logic for XXEClassicPage.xaml
    /// </summary>
    public partial class XXEClassicPage : Page
    {
        #region Private Fields

        private const string ClassicPage = "classic.svg";
        private const string SvgFileName = "classic-test.svg";
        private const string BackFileName = "classic-test.bak";
        ...
        public XXEClassicPage()
        {
            ...
            _svgFilePath = IoPath.Combine(workingDir, ClassicPage);
            _testFilePath = IoPath.Combine(workingDir, SvgFileName);
