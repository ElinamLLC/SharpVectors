...
namespace WpfXXETestBox
{
    ...
    public partial class SvgPage : Page
    {
        ...
        private const string InputPage     = "input.svg";
        private const string TestFileName  = "input-test.svg";
        private const string BackFileName  = "input-test.bak";
        private const string XamlFileName  = "input-test.xaml";
...
//            string workingDir = PathUtils.Combine(Assembly.GetExecutingAssembly());
            ...
            _svgFilePath = IoPath.Combine(workingDir, InputPage);
        ...
        public void UnInitializePage()
        {
            ...
            if (!string.IsNullOrWhiteSpace(_xamlFilePath) && File.Exists(_xamlFilePath))
            {
