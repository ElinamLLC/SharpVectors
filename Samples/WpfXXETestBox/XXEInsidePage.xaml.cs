...
{
    /// <summary>
    /// Interaction logic for XXEInsidePage.xaml
    /// </summary>
    public partial class XXEInsidePage : Page
    {
        #region Private Fields

        private const string InsidePage   = "inside.svg";
        private const string TestFileName = "inside-test.svg";
        private const string BackFileName = "inside-test.bak";
        ...
        public XXEInsidePage()
        {
            ...
            _svgFilePath = IoPath.Combine(workingDir, InsidePage);
